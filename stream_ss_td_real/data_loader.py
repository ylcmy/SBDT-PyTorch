...
def load_acc_train(fold_path="../data_real/acc/ibm-large-tensor.txt"):
    y = []
    ind = []
...
def load_acc_test_long(fold_path="./data_real/acc/acc_test.mat"):
...
def load_CTR_new(fold_path="../data/CTR/"):
    load_train = pd.read_csv(
        "../data/CTR/CTR_train_1m_new.txt", sep=" ", header=None
    ).values
    load_test = pd.read_csv(
        "../data/CTR/CTR_test_100k_new.txt", sep=" ", header=None
    ).values
