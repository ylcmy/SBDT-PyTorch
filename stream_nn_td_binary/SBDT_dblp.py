...
ndims = [10000, 200, 10000]
ind, y = data_loader.load_dblp_train(
    fold_path="./data_binary/dblp/dblp-large-tensor.txt"
)
ind_test, y_test = data_loader.load_dblp_test()
...
for mini_batch in mini_batch_list:
    for R in R_list:
        help_str = "dblp_" + str(mini_batch) + "_" + str(R)
